...
resource "aws_lambda_function" "lambda" {
  ...
  function_name    = "${var.environment_key}-${var.logzio__module_name}-ship-logzio"
...
resource "aws_iam_role" "lambda_role" {
  name               = "${var.environment_key}-${var.logzio__module_name}-cloudwatch-to-logzio"
...
resource "aws_lambda_permission" "allows_cloudwatch_execute_lambda" {
  statement_id  = "${var.environment_key}-${var.logzio__module_name}-allows-cloudwatch-execute-lambda"
